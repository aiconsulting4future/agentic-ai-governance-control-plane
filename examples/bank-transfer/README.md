...
Route closure is a bounded claim: `CLOSED` means the identified, in-scope consequence-bearing routes within the declared system boundary are governed. It does not prove that every possible infrastructure, administrative, malicious, or future route has been discovered.
